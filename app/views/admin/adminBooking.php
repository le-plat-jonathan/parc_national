...
// Chemins des vues (modifié pour "booking")
$pathGetAllBooking = $basePath . 'booking/getAllBooking.php';
$pathUpdateBooking = $basePath . 'booking/updateBooking.php';
$pathDeleteBooking = $basePath . 'booking/deleteBooking.php';
...
<body>
  <header style="background-color: #15505B;" class="header" id="header">
    ...
    <main>
        <div id="display_view">
            <!--Search-->
            <a href="<?= $pathGetAllBooking ?>" class="display_views">
                <p>Voir toutes les réservations</p>
            </a>
            <a href="<?= $pathUpdateBooking ?>" class="display_views">
                <p>Modifier une réservation</p>
            </a>
            <a href="<?= $pathDeleteBooking ?>" class="display_views">
