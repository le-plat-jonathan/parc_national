...
$urlForAction = str_replace('/views/booking/deleteBooking.php', '/routes/bookingRoutes.php/deleteBooking', $uri);
...
<body>
    ...
    <main>
        ...
        <form action="<?= $urlForAction ?>" method="post" id="form_admin">
            <label for="id">Id de la réservation à supprimer</label>
